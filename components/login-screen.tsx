      ...
      <div className="relative z-10 w-full max-w-md space-y-8 animate-in fade-in-0 slide-in-from-bottom-4 duration-1000">
        <div className="text-center space-y-4">
          <div className="flex justify-center">
            <img
              src={theme === "dark" ? "/noxlogo.png" : "/noxlogo.png"}
        ...
        <Card className="bg-card/95 backdrop-blur-sm border-border/60 shadow-2xl">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full gradient-lime hover:gradient-lime-hover text-primary-foreground font-semibold py-2.5 transition-all duration-300 transform hover:scale-[1.02] disabled:scale-100"
                disabled={isLoading}
              >
                {isLoading ? (
                  <div className="flex items-center space-x-2">
