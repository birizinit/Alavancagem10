...
export function Dashboard({ apiKey, onLogout }: DashboardProps) {
  ...
  // Lógica do Martingale: dobra o valor após cada perda consecutiva
  useEffect(() => {
  ...
  useEffect(() => {
    // Service Worker desabilitado temporariamente devido a problemas de cache
    // Desregistrar qualquer Service Worker existente
    if ("serviceWorker" in navigator) {
      navigator.serviceWorker.getRegistrations().then((registrations) => {
        registrations.forEach((registration) => {
          registration.unregister()
          console.log("[v0] Service Worker desregistrado")
        })
      })
    }
  ...
  return (
    <div className="min-h-screen bg-background animate-in fade-in-0 duration-1000">
        ...
        <Card className="bg-card/90 border-border/60 overflow-hidden hover:border-primary/40 transition-all duration-300 shadow-lg">
          <CardContent className="p-6">
            ...
            <div className="flex gap-3">
              <Button
                className="flex-1 gradient-lime hover:gradient-lime-hover text-black font-semibold py-3 rounded-lg transition-all duration-300 hover:scale-105"
              ...
              <Button
                className="flex-1 border-4 border-white text-white hover:bg-white/20 py-3 rounded-lg transition-all duration-300 hover:scale-105 bg-transparent"
                onClick={scrollToTradingSection}
              >
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col gap-3 sm:gap-4">
                <div className="flex items-center justify-center p-3 rounded-lg border border-border/40" style={{ backgroundColor: 'rgba(25, 26, 22, 0.6)' }}>
                  ...
                  className={`w-full ${
                    botEnabled 
                      ...
                      : isBotConfigValid() 
                        ...
                        : "gradient-lime hover:gradient-lime-hover"
            ...
            <div className="mb-6 p-4 rounded-lg border border-border/40" style={{ backgroundColor: 'rgba(25, 26, 22, 0.6)' }}>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-6 p-3 sm:p-4 rounded-lg border border-border/40" style={{ backgroundColor: 'rgba(25, 26, 22, 0.6)' }}>
              <div className="text-center p-2">
                <p className="text-xs font-medium text-foreground mb-1">Ativos</p>
                <p className="text-xs text-muted-foreground leading-tight">ADAUSDT, XRPUSDT, ETHUSDT, BTCUSDT, SOLUSDT...</p>
              </div>
              <div className="text-center p-2">
            ...
            <div ref={tradingSectionRef} className="mb-6">
              ...
              <div className="h-[800px] rounded-lg overflow-hidden border border-border/40">
                <iframe
                  src="https://app.noxoption.com"
                  title="ALAVANCAGEM 10XOption Trading Platform"
                  ...
                  {(activeTrades.length === 0 && completedTrades.length === 0) ? (
                    ...
                    <>
                      ...
                      <div
                        ...
                        style={{ backgroundColor: 'rgba(25, 26, 22, 0.6)' }}
                      >
                        <div className="flex items-center gap-2">
      ...
      <AlertDialog open={showWelcomeDialog} onOpenChange={setShowWelcomeDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Bem-vindo ao ALAVANCAGEM 10X!</AlertDialogTitle>
            <AlertDialogDescription>
